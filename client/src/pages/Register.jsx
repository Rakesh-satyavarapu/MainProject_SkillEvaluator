...
const Register = () => {
  ...
  const submitHandler = async (e) => {
    ...
    if (validateForm()) {
      setIsLoading(true);
      await signUp({ name: username, email: email.toLowerCase(), password });
      setIsLoading(false);
    }
    setUsername('');
    setEmail('');
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-white to-secondary-50 p-4">
      ...
      >
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-100 p-8">
          {/* Logo and Header */}
          <div className="text-center mb-8">
            <motion.div
              ...
              className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-primary-600 to-secondary-600 mb-4"
            >
          ...
          <form onSubmit={submitHandler} className="space-y-5">
            ...
            <motion.button
              ...
              className={cn(
                ...
                "bg-gradient-to-r from-primary-600 to-secondary-600 text-white font-semibold",
